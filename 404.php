  ...
  <?php roots_content_before(); ?>
    ...
    <?php roots_main_before(); ?>
        ...
        <h1><?php _e('Page Not Found', 'roots'); ?></h1>
			We offer services that will help take your business to the next level</div>
        <!-- catchbox ends -->
    <div class="container">
    <div class="row">
      <div id="main" class="<?php echo FULLWIDTH_CLASSES; ?>" role="main">
		...
		<div style="float:right;">
			<a href="http://webento.com/" title="Webento"><img src="http://webento.com/wp-content/login-image/login-form-image.png"></a>
		</div>
