<div class="entry-optin-optin align<?php echo $align; ?>">
	...
	<div class="optin-box">
	<?php if ( ! $complete ) { ?>
		<form class="" method="post" action="<?php echo esc_attr(add_query_arg(array())); ?>#mc<?php echo $mcnumber; ?>" id="mc<?php echo $mcnumber; ?>">
			...
			<ul class="form-container">
				...
				<li class="premise-form-container-submit">
					<input type="submit" name="mailchimp[signup]" id="mailchimp-signup" value="<?php _e('Signup', 'premise' ); ?>" />
				</li>
			</ul>
			...
			<input type="hidden" name="mailchimp[currenturl]" id="mailchimp-currenturl" value="<?php echo esc_attr(add_query_arg(array())); ?>" />

		</form>
	<?php 
	} // complete

	$this->mailchimp_confirm();
	?>
	</div>
</div>