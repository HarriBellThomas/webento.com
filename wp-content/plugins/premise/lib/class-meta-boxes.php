...
class Premise_Meta_Boxes {
	function Premise_Meta_boxes( $post ) {
	...
	function seo_options( $post ) {
		...
		$type = $premise_base->get_page_type( $post->ID );
		$seo = $premise_base->get_premise_meta( $post->ID, 'seo' );
	...
	function tracking_options( $post ) {
		...
		$type = $premise_base->get_page_type( $post->ID );
		$tracking = $premise_base->get_premise_meta( $post->ID, 'tracking' );
