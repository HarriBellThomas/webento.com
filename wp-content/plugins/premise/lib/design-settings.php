...
function premise_get_mapping() {
	...
	$mapping = array (
		...
		'#content .gform_footer .button, #content .button, #content input[type=submit], #content input.submit' => array(
		...
		'#content .gform_footer .button:hover, #content .button:hover, #content input[type=submit]:hover, #content input.submit:hover' => array(
		...
		'.coda-nav-left a, .coda-nav-right a' => array(
		...
		'.coda-nav ul li a.current' => array(
		...
		'.entry-video .container-border' => array(
		...
		'.teaser-share-icons a:hover' => array(
...
function premise_settings_global() {
	...
	if(isset($_GET['premise-design-key']) && $Premise->isValidStyleKey($_GET['premise-design-key'])) {
		...
		global $premise_style_configuration_should_use_defaults;
