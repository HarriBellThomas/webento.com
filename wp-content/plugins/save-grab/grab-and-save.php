...
class GrabAndSave {
	...
	function media_process() {
		...
		<input id="src" type="text" name="imageurl"><input type="submit" class="button" value="Grab">
		</div>
		...
		?>
		<div style="padding:10px;"><a href="http://digitalmemo.neobie.net/grab-save/" target="digitalmemo" style="text-decoration:none;font-size:0.8em;">&copy; neobie @ DigitalMemo</a></div>
		<?php
	}
