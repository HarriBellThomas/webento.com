...
switch ($current_theme) {
	...
	case 'Generate Child Theme';
		DEFINE ( 'HEADER_IMAGE_WIDTH', '960' );
		DEFINE ( 'HEADER_IMAGE_HEIGHT', '100' );
		DEFINE ( 'THEME_CSS_VALUE', '#title-area' );
		DEFINE ( 'BACKGROUND_TYPE', 'background' );
		$gsh_extras = 'margin: 0 auto 0!important';
		$ghs_extras_2 = '#header { background: none!important; }';
	break;
	...
	case 'Outreach Child Theme';
		DEFINE ( 'HEADER_IMAGE_WIDTH', '400' );
		DEFINE ( 'HEADER_IMAGE_HEIGHT', '120' );
		DEFINE ( 'THEME_CSS_VALUE', '#header .wrap' );
		DEFINE ( 'BACKGROUND_TYPE', 'background' );
		$gsh_extras = 'margin: 0 auto 0!important';
		$ghs_extras_2 = '#header { background: none!important; }';
	break;
...
if (defined('HEADER_IMAGE_WIDTH') && defined('HEADER_IMAGE_HEIGHT')) {
	...
	add_theme_support( 'genesis-custom-header', array( 'textcolor' => 'ffffff', 'admin_header_callback' => 'admin_simpleheader_style' ) );
