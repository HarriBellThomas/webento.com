...
<div class="ecordia-analyze-action">
	...
	<div class="alignleft">
		<p>
			<a href="<?php echo esc_url(admin_url('media-upload.php?tab=ecordia-score&type=ecordia-score&post=' . $post->ID . '&TB_iframe=true')); ?>" id="ecordia-seo-analysis-review-button" class="button"><?php _e( 'Review' ); ?></a>
		</p>
	</div>
