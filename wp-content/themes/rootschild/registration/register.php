<?php get_header( 'buddypress' ) ?>
	<div id="content" class="bp_content register-content">
		<div class="padder">
		...
		<div class="page" id="register-page">
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<?php if ( bp_get_blog_signup_allowed() ) : ?>
					...
					<div class="register-section clearfix" id="blog-details-section">
						...
						<p style="display:none"><input type="checkbox" name="signup_with_blog" id="signup_with_blog" value="1" checked="checked" /> <?php _e( 'Yes, I\'d like to create a new site', 'buddypress' ) ?></p>
						...
						<div id="blog-details"<?php if ( (int) bp_get_signup_with_blog_value() ) : ?>class="show"<?php endif; ?>>
							...
							<div class="ctrlHolder fullwidth">
							<label style="display:inline-block; margin-right:10px;"><input type="radio" name="signup_blog_privacy" id="signup_blog_privacy_public" value="public"<?php if ( 'public' == bp_get_signup_blog_privacy_value() || !bp_get_signup_blog_privacy_value() ) : ?> checked="checked"<?php endif; ?> /> <?php _e( 'Yes', 'buddypress' ) ?></label>
							<label style="display:inline-block;"><input type="radio" name="signup_blog_privacy" id="signup_blog_privacy_private" value="private"<?php if ( 'private' == bp_get_signup_blog_privacy_value() ) : ?> checked="checked"<?php endif; ?> /> <?php _e( 'No', 'buddypress' ) ?></label>
							</div>
						</div>
			...
			<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
				...
				<?php if ( bp_registration_needs_activation() ) : ?>
					<p><?php _e( 'You have successfully created your account! To begin using this site you will need to activate your account via the email we have just sent to your address. Please make sure to check your junk/spam folder.', 'buddypress' ) ?></p>
				<?php else : ?>
