<?php 
/**
Template Name: Why Webento Template
/**/
get_header(); ?>
		...
		<div class="clearfix container_12 innercont">
            ...
            <div class="grid_12 floatright clearfix">
                ...
                <div>               
					...
					<div class="grid_13 srvcsec floatleft"  >
					 <!-- <p><img src="http://webento.com/wp-content/themes/roots/img/in-thumb.jpg" width="260" height="105" alt="" /></p> -->
					<h3>We specialize in fixing under-performing websites.</h3> 
					...
					<div class="grid_13 srvcsec floatleft"  >
					<!-- <p><img src="http://webento.com/wp-content/themes/roots/img/in-thumb.jpg" width="260" height="105" alt="" /></p> -->
					<h3>We help you get found online through Search Engines, Social Media and Local Search Optimization.</h3> 
