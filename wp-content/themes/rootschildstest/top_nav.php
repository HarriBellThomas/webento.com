<div class=" container_12">
		...
		<div class="grid_9">
			...
			?>	
					<script type="text/javascript">
						...
						login_li.html('<a href="/wp-admin/" class="dropdown-toggle" data-toggle="dropdown">Dashboard <b class="caret"></b></a><ul class="dropdown-menu"><li><a href="<?php echo $profile_link; ?>">Profile</a></li><li><a href="<?php echo $logout_str;?>">Logout</a></li></ul>');
					</script>
			<?php
				}
			?>
	...
	<div style="display: none;">
		...
		<div class="loginbox_lightbox">
			<form name="loginform_lightbox" id="loginform_lightbox" action="/wp-login.php" method="post">
