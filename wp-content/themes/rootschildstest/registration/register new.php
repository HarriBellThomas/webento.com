		...
		<div class="page" id="register-page">
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<div class="register-section" id="basic-details-section">
					...
					<table id="register-form-table" style="width:700px;">
                    <tr>
				...
				<?php if ( bp_get_blog_signup_allowed() ) : ?>
					...
					<div style="display:none" class="register-section" id="blog-details-section">
				...
				<?php do_action( 'bp_before_registration_submit_buttons' ) ?>
					...
					<input class="formBtn" style="margin-left: 90px;" type="submit" name="signup_submit" id="signup_submit" value="<?php _e( 'Complete Sign Up', 'buddypress' ) ?>" />
