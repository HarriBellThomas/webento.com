...
<?php }
add_custom_image_header('', 'blogsmu_admin_header_style');
}
...
<img src="<?php header_image(); ?>" alt="<?php echo bloginfo('name'); ?>" /></a>
</div>
<?php } ?>
<?php }
...
<?php add_action('admin_head', 'dev_remove_all_scripts', 100); } else if($_GET["page"] == "custom-homepage.php") { ?>
<?php print "<style type=\"text/css\">"; ?>
